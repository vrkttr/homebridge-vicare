...
class ViCareThermostatPlatform {
  ...
  authenticate(callback) {
    const authUrl = `https://iam.viessmann.com/idp/v3/authorize?client_id=${this.clientId}&redirect_url=${encodeURIComponent(this.redirectUri)}&scope=IoT%20User&response_type=code&code_challenge_method=S256&code_challenge=${this.codeChallenge}`;
